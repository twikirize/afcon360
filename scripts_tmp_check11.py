...
with app.test_request_context('/kyc/'):
    html = render_template(
        ...
        missing_requirements=[],  # EMPTY - should trigger for-else
...
sections = {
    'kyc-requirement-card-list': 'kyc-requirement-card-list',
    'panel kyc-requirements': 'id="kyc-requirements"',
    'All required checks are complete': 'All required checks are complete',
    'Your verification decision': 'Your verification decision',
    'Verification Progress': 'Verification Progress',
    'What happens next': 'What happens next',
}
for name, search in sections.items():
