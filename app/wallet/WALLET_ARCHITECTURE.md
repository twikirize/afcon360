...
├── user_id              BIGINT (internal FK to users.id OR organisations.id)
...
- Checkout must **not** create an account. User must choose a non-wallet
  payment method or complete wallet activation first.
