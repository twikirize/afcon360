...
admin_ultimate_bp = Blueprint('admin_ultimate', __name__, url_prefix='/admin')

@admin_ultimate_bp.route('/manage-users')
@login_required
@admin_required
def manage_users():
...
@admin_ultimate_bp.route('/verify-user/<int:user_id>', methods=['POST'])
@login_required
@admin_required
...
@admin_ultimate_bp.route('/activate-user/<int:user_id>', methods=['POST'])
@login_required
@admin_required
...
@admin_ultimate_bp.route('/deactivate-user/<int:user_id>', methods=['POST'])
@login_required
@admin_required
...
@admin_ultimate_bp.route('/delete-user/<int:user_id>', methods=['POST'])
@login_required
@admin_required
...
@admin_ultimate_bp.route('/bulk-verify-users', methods=['POST'])
@login_required
@admin_required
...
@admin_ultimate_bp.route('/bulk-activate-users', methods=['POST'])
@login_required
@admin_required
...
@admin_ultimate_bp.route('/bulk-deactivate-users', methods=['POST'])
@login_required
@admin_required
...
@admin_ultimate_bp.route('/view-user/<int:user_id>')
@login_required
@admin_required
...
@admin_ultimate_bp.route('/promote-user/<int:user_id>', methods=['POST'])
@login_required
@admin_required
...
@admin_ultimate_bp.route('/demote-user/<int:user_id>', methods=['POST'])
@login_required
@admin_required
...
@admin_ultimate_bp.route('/sign-in-as/<int:user_id>', methods=['POST'])
@login_required
@admin_required
...
@admin_ultimate_bp.route('/suspend-user/<int:user_id>', methods=['POST'])
@login_required
@admin_required
...
@admin_ultimate_bp.route('/wallet/webhooks/<int:event_id>')
@login_required
@admin_required
...
@admin_ultimate_bp.route('/wallet/webhooks/stats')
@login_required
@admin_required
