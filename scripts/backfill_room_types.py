#!/usr/bin/env python
"""
Backfill script: Create one RoomType per existing Property.

This script should be run once after the RoomType model is added.
It creates a default RoomType for each Property that doesn't have one yet.

Usage: flask run -c "from scripts.backfill_room_types import backfill; backfill()"
Or: python -c "from scripts.backfill_room_types import backfill; backfill()"
"""
...
def backfill():
    """Create a default RoomType for each Property without one."""
